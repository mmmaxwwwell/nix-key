...
class NixKeyE2EHelper(
     ...
     */
    fun waitForApp(timeout: Long = DEFAULT_TIMEOUT_MS): Boolean =
        retry("waitForApp") {
     ...
     */
    fun navigateToKeys(): Boolean =
        retry("navigateToKeys") {
     ...
     */
    fun createKey(name: String, type: String): Boolean =
        retry("createKey($name, $type)") {
     ...
     */
    fun pairWithHost(qrPayload: String): Boolean =
        retry("pairWithHost") {
     ...
     */
    fun approveSignRequest(timeout: Long = DEFAULT_TIMEOUT_MS): Boolean =
        retry("approveSignRequest") {
     ...
     */
    fun denySignRequest(): Boolean =
        retry("denySignRequest") {
     ...
     */
    fun enterTailscaleAuthKey(key: String): Boolean =
        retry("enterTailscaleAuthKey") {
